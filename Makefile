...
help:
	...
	@echo "  See ./scripts/workshop-setup.sh for automated setup"
	@echo "  See ./scripts/deploy-sno.sh for SNO deployment"
	@echo "  See ./scripts/destroy-sno.sh for cluster cleanup"
	@echo ""
