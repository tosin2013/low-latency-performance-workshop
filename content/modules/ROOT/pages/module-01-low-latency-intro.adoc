...
For RHPDS deployments, click below to launch your pre-configured Dev Spaces workspace:

link:{devspaces_factory}[🚀 *Open in Dev Spaces*,role=button]

This will create a workspace with all tools pre-installed and your SNO cluster credentials auto-mounted.
====
