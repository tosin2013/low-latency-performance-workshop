...
[TIP]
====
*Quick Login to Your SNO Cluster*

Login to your SNO cluster:

[source,bash,role=execute,subs="attributes"]
----
oc login {cluster_api} -u {username} -p <workshop-password>
----

Replace `<workshop-password>` with the password provided by your administrator.
====
...
Before beginning performance testing, you must connect to your SNO cluster that was set up and verified in Module 2.
...
[TIP]
====
If you don't have cluster access:

1. SSH to your bastion host (from Module 2)
2. The kubeconfig is pre-configured on the bastion
3. Run `oc get nodes` to verify access
