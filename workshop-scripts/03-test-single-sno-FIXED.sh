...
#
# Examples:
#   ./03-test-single-sno-FIXED.sh student1           # RHPDS mode (default, with hub integration)
#   ./03-test-single-sno-FIXED.sh student1 rhpds     # RHPDS mode (explicit)
#   ./03-test-single-sno-FIXED.sh student1 standalone # Standalone mode (no hub integration)
